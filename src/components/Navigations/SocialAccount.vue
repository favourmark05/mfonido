<template>
  ...
  >
    ...
    <a href="https://x.com/MfonidoMark" class="hover:text-white transition duration-300">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        class="w-5 h-5"
    ...
    <a href="https://www.linkedin.com/in/mfonido-mark-4baa42120/" class="hover:text-white transition duration-300">
