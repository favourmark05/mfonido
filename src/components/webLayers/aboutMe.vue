        ...
        <div class="contain">
          <div class="col-1">
            ...
            <p>
              ...
              I have over 6years of Industry experience building the frontend part of web Applications / Products.
          ...
          <div class="col-1">
            <div class="certificate">
              <img
                src="../../assets/cert.png"
                alt="cert1"
                class="certificate-photos cert1"
              />
              <img
                src="../../assets/cert1.png"
                alt="cert2"
                class="certificate-photos cert2"
              />
              <img
                src="../../assets/cert2.png"
                alt="cert3"
                class="certificate-photos cert3"
              />
            </div>
          </div>
        </div>
